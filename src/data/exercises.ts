...
export const EXERCISE_DATABASE: Exercise[] = [
  ...
  { id: 'e022', name: 'Barbell Row (Bent Over)', muscleGroup: 'Back', secondaryMuscles: ['Biceps', 'Shoulders'], equipment: 'Barbell', type: 'compound' },
  ...
  { id: 'e028', name: 'Seated Cable Row', muscleGroup: 'Back', secondaryMuscles: ['Biceps', 'Shoulders'], equipment: 'Cable', type: 'compound' },
  { id: 'e029', name: 'Single Arm Dumbbell Row', muscleGroup: 'Back', secondaryMuscles: ['Biceps'], equipment: 'Dumbbell', type: 'compound' },
  { id: 'e030', name: 'T-Bar Row', muscleGroup: 'Back', secondaryMuscles: ['Biceps', 'Shoulders'], equipment: 'Barbell', type: 'compound' },
